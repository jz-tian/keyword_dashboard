...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-9 w-full items-center justify-between gap-2 rounded-[var(--radius-card)]",
      "border border-[var(--color-border)] bg-[var(--color-surface-2)] px-3 py-1",
      "text-sm font-[var(--font-sans)] text-[var(--color-text)]",
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      "rounded-[calc(var(--radius-card)/2)] py-1.5 pl-8 pr-2 text-sm",
